...
az network vpn-connection create -n onprem2-to-we-hub --vnet-gateway1 qonprem2-gw -g vwan-ri-terraform-rg --local-gateway2 lng2 -l westeurope --shared-key $sharedkey --enable-bgp
