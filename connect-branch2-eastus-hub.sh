...
az network vpn-gateway connection create --gateway-name demo-eastus-hub-vpngw --name onprem2 --remote-vpn-site onprem2 -g vwan-ri-terraform-rg --shared-key $sharedkey --enable-bgp true --no-wait
